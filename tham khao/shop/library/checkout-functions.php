...
function saveOrder()
{
	...
	if (checkRequiredPost($requiredField)) {
		...
		// ký tự đầu tiên trong customer và  city name là 
		// customer and city name được viết hoa
		...
		if ($orderId) {
			...
			// sau đó remove ordered items trong giỏ hàng
			for ($i = 0; $i < $numItem; $i++) {
...
/*
	Lấy hóa đơn tổng tiền ( total purchase + shipping cost )
*/
