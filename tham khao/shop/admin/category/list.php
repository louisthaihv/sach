...
// cho phân trang
// bao nhiêu dòng hiển thị trên 1 trang
$rowsPerPage = 5;
...
?>
  ...
  <tr> 
   <td colspan="5" align="right"> <input name="btnAddCategory" type="button" id="btnAddCategory" value="Thêm danh mục" class="box" onClick="addCategory(<?php echo $catId; ?>)"> 
   </td>
  </tr>
 </table>
 <p>&nbsp;</p>
