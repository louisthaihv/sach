...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="1" class="graybox">
  ...
  <tr>
    <td width="150" valign="top" class="navArea"><p>&nbsp;</p>
      <a href="<?php echo WEB_ROOT; ?>admin/" class="leftnav">Trang chủ</a> 
	  <a href="<?php echo WEB_ROOT; ?>admin/category/" class="leftnav">Danh mục</a>
	  <a href="<?php echo WEB_ROOT; ?>admin/product/" class="leftnav">Sản phẩm</a> 
	  <a href="<?php echo WEB_ROOT; ?>admin/order/?status=Paid" class="leftnav">Sắp xếp báo cáo</a> 
	  <a href="<?php echo WEB_ROOT; ?>admin/config/" class="leftnav">Tùy chỉnh</a> 
	  <a href="<?php echo WEB_ROOT; ?>admin/user/" class="leftnav">Thành viên</a> 
