...
<form action="processUser.php?action=addUser" method="post"  name="frmListUser" id="frmListUser">
 <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="text">
  <tr align="center" id="listTableHeader"> 
   <td>Tên</td>
   <td width="120">Ngày đăng ký</td>
   <td width="120">Đăng nhập cuối</td>
   <td width="120">Thay Password</td>
   <td width="70">Xóa</td>
  </tr>
<?php
...
?>
  ...
  <tr> 
   <td colspan="5" align="right"><input name="btnAddUser" type="button" id="btnAddUser" value="Thêm thành viên" class="box" onClick="addUser()"></td>
  </tr>
 </table>
 <p>&nbsp;</p>
</form>