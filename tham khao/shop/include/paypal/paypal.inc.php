<?php
/*
 * File chứa các tùy chỉnh về paypal và một số hàm.
 *
 */

$paypal = array();

$paypal['business']      = "chuanhtien@gmail.com";
$paypal['site_url']      = "http://www.bansach.nuocviet.vn/";
$paypal['image_url']     = "";
$paypal['success_url']   = "success.php";
$paypal['cancel_url']    = "error.php";
$paypal['notify_url']    = "include/paypal/ipn.php";
$paypal['return_method'] = "2"; //1=GET 2=POST               --> Sử dụng post từ khi ta cần trả về giá trị để kiểm tra các báo cáo
...
$paypal['display_shipping_address'] = "1"; //""=yes 1=no     --> Địa chỉ nhận hàng để paypal không hỏi lại
...
//tạo biên thực hiện tiến trình báo cáo
...
//hàm tạo dấy phảy giữa các giá trị của file từ mảng. 
...
function create_csv_file($file,$data) 
{
	...
	if (is_array($data)) { 
		...
		//Gỡ dấu phảy cuối của chuỗi
		$csv = substr($csv,0,-1); 
		
		//Kiểm tra sự xuất hiện của file
