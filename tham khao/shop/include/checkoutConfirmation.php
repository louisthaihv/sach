<?php
/*
Line 1 : Chắc chắn file này bao gồm yêu cầu trực tiếp
Line 2 : Kiểm tra bước này được định nghĩa và giá trị là 2
Line 3 : Yêu cầu POST phải có từ trang này, nhưng giá trị của bước là 1
*/
if (!defined('WEB_ROOT')
...
/*
 Chắc chắn tất cả trường yêu cầu xuất hiện là $_POST và giá trị không rỗng
*/
